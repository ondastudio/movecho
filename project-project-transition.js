...
function projectProjectTransition() {
  ...
  const projectBanner = document.querySelector(".project-banner_wrap");
  gsap.fromTo(
    projectBanner.firstChild,
    {
      scale: 1.5,
    },
    {
  ...
  const img = projectBanner.querySelector(".image");
  imageParallax(projectBanner, img);
  ...
  const projectLinks = document.querySelectorAll(".project-swiper-link");
